...
<%
     ...
     */
%>
<input onkeyup="CMMN_SEARCH_DATE['${param.startDateNm}'].inputDateFormat(this)" id="${param.startDateNm}" readonly
       maxlength="10" name="${param.startDateNm}"/> <!-- 시작일 -->
<span class="split">~</span>
<input onkeyup="CMMN_SEARCH_DATE['${param.startDateNm}'].inputDateFormat(this)" id="${param.endDateNm}" readonly
