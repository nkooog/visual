...
<p class="formAlign">
    <input id="${param.startDateNm}" name="${param.startDateNm}" style="width: 110px;" />  ~  <input id="${param.endDateNm}" name="${param.endDateNm}" style="width: 110px;" />
</p>
<c:choose>
    <c:when test="${param.searchType eq 'month'}">
        <p class="formAlignBlock ma_top5">
