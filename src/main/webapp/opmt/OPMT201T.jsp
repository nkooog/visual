...
/*         .content_01 .size_button { width: 80%;height: 75%;display: flex;flex-direction: column;justify-content: center;} */
                ...
                if(result.modelAndView.status == "OK")
               	{
                    ...
                    if(info.category == "p")
                   	{
                    	$(".number").css("color", info.buttonFontColor);
...
//                    		$("#contentTelnum").text(info.telnum);
                    ...
                    if(info.bottomButtonUseyn == "Y")
                    {
	                	...
	                	for(var i=0; i<buttonTitleList.length; i++)
	                	{
	                    	...
	                    	html += '<form method="post" id="form_button_'+(i+1)+'" action="/visual/opmt/BtnClick">';
